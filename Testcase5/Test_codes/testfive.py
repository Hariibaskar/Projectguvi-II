...
class Test_Hari:
    ...
    def test_login(self, booting_function):
        ...
        time.sleep(3)
        e=self.driver.find_element(by=By.XPATH, value=data.Hari_Selectors.indian_xpath)
        self.driver.execute_script('arguments[0].innerHTML = "Indian";',e)
        time.sleep(3)
        self.driver.find_element(by=By.XPATH, value=data.Hari_Selectors.maritalstatus_xpath).click()
        time.sleep(3)
        e1=self.driver.find_element(by=By.XPATH, value=data.Hari_Selectors.single_xpath)
        self.driver.execute_script('arguments[0].innerHTML = "Single";',e1)
        time.sleep(5)
        ...
        time.sleep(10)
        assert self.driver.title == 'OrangeHRM'
        print("Successfully created personal details")